<?php
/**
 * ChurrascoPlanet Core - Data Models
...
// ============================================================================
// FUNCIONES HELPER GLOBALES - SIEMPRE SE DEFINEN PRIMERO
// Esto evita el error "Call to undefined function" cuando class-compat.php
// intenta usar estas funciones
// ============================================================================
...
if (!function_exists('chp_config')) {
    function chp_config($key, $default = '') {
        // Si la clase no existe aún, devolver default
...
if (!function_exists('chp_set_config')) {
    function chp_set_config($key, $value, $tipo = 'text') {
        // Si la clase no existe aún, devolver false
        if (!class_exists('ChurrascoPlanet_Config_Model')) {
            return false;
        }
...
if (!function_exists('chp_get_locales')) {
    function chp_get_locales() {
        // Si la clase no existe aún, devolver array vacío
        if (!class_exists('ChurrascoPlanet_Locales_Model')) {
            return array();
        }
...
if (!function_exists('chp_get_nav_items')) {
    function chp_get_nav_items() {
        // Si la clase no existe aún, devolver array vacío
        if (!class_exists('ChurrascoPlanet_Nav_Model')) {
            return array();
        }
...
if (!function_exists('chp_get_all_extras_grupos')) {
    function chp_get_all_extras_grupos() {
        // Si la clase no existe aún, devolver array vacío
        if (!class_exists('ChurrascoPlanet_Extras_Grupos_Model')) {
            return array();
        }
...
if (!function_exists('chp_get_info_items')) {
    function chp_get_info_items($seccion) {
        // Si la clase no existe aún, devolver array vacío
        if (!class_exists('ChurrascoPlanet_Info_Items_Model')) {
            return array();
        }
...
// Si la clase base ya existe (cargada por el tema), no redeclararla
if (class_exists('ChurrascoPlanet_Model')) {
    return;
}
...
// Nota: Las funciones helper globales se definen al INICIO de este archivo
