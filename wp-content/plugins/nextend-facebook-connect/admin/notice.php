...
$current = time();
if (mktime(0, 0, 0, 11, 24, 2025) <= $current && $current < mktime(0, 0, 0, 12, 2, 2025)) {
    if (get_option('nsl_bf_2025') != '1') {

        add_action('admin_notices', function () {
            ?>
            <div class="notice notice-info is-dismissible" data-nsldismissable="nsl_bf_2025" style="display:grid;grid-template-columns: 100px auto;padding-top: 25px; padding-bottom: 22px;">
                ...
                <p style="margin:0 0 2px;">Don't miss out on our biggest sale of the year! Get your <b>Pro Addon</b>
                    ...
                    This limited time offer expires on December 1.</p>
                <p style="margin:0;">
                    <a class="button button-primary" href="https://social-login.nextendweb.com/pricing/?coupon=BF2025&utm_source=wpfree&utm_medium=wp&utm_campaign=bf25" target="_blank">
                        Buy Now</a>
